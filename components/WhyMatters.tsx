      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-24 items-center">
        ...
        <div className="order-1 md:order-2 space-y-10">
           ...
           <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter leading-[0.9]">
             Why Scrutiny <br />
             <span className="text-emerald-500 text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-emerald-300">Is Non-Negotiable</span>
           </h2>
           <p className="text-xl text-slate-400 leading-relaxed font-medium">
             As Large Language Models move from experimentation to production, the risk of "Logical Collapse" grows. In regulated industries—Finance, Legal, Healthcare—a simple hallucination can have catastrophic consequences.
           </p>
           ...
           <div className="flex items-start space-x-6 p-8 bg-slate-900/50 rounded-3xl border border-slate-800">
              ...
              <p className="text-sm text-slate-400 leading-relaxed font-medium italic">
                "Axiom Audit provides the defensive layer required to deploy generative AI with absolute confidence in enterprise environments."
              </p>
           </div>
        </div>
      </div>
